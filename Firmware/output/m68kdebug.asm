; C:\USERS\ADMIN\DESKTOP\ASSIGNMENT1\SRAM_CONTROLLER\M68KV6.0-800BY480\PROGRAMS\DEBUGMONITORCODE\M68KDEBUG.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
...
; scanf("%u", &test_type);
       ...
       jsr       (A4)
       addq.w    #8,A7
; while (test_type > 2) // execute here only if input is invalid
MemoryTest_1:
       move.l    -12(A6),D0
       cmp.l     #2,D0
       bls.s     MemoryTest_3
...
; scanf("%x", &end_address); //protect data leak into other memories
       ...
       jsr       (A4)
       addq.w    #8,A7
; while (end_address < start_address || end_address > 0x08030000)
MemoryTest_31:
       move.l    -16(A6),D0
       cmp.l     -20(A6),D0
       blo.s     MemoryTest_34
...
; if (test_type != 0) // check that we're aligned properly for start address for word and long word
       ...
       beq       MemoryTest_39
; {
; while ((unsigned int)end_address % 2) // odd number address
MemoryTest_37:
       move.l    -16(A6),-(A7)
       pea       2
       jsr       ULDIV
...
MemoryTest_41:
; }
; // test for byte first, then check alignment
; // test case: current is 0x0802_0000, end is 0x0802_000a (end-start = 10 in decimals)
; // byte --> just 8 bits
; // 16b'1111_1111_1111_1111
; // 16b'0000_0000_1011_1100 input
; //and  16b'0000_0000_1011_1100
; //>>8  16b
; mem_error_flag = 0;
       clr.l     D3
...
; char c ;
; int i, j ;
; char *student_names = "Saif Abdelazim and Jinil Patel"; // change this + variable name to student name
       lea       @m68kde~2_164.L,A0
       move.l    A0,D3
; char *student_number = "Student #: 62639422 and 3824072"; // change this + variable name to student number
...
@m68kde~2_163:
       ...
       dc.b      120,0
@m68kde~2_164:
       dc.b      83,97,105,102,32,65,98,100,101,108,97,122,105
       dc.b      109,32,97,110,100,32,74,105,110,105,108,32,80
       dc.b      97,116,101,108,0
@m68kde~2_165:
       dc.b      83,116,117,100,101,110,116,32,35,58,32,54,50
       dc.b      54,51,57,52,50,50,32,97,110,100,32,51,56,50
       dc.b      52,48,55,50,0
@m68kde~2_166:
